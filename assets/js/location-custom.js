(() => {
  ...
  const T = {
  "meta": {
    "version": "20260713-ryczywol-unifiedstyle3",
  ...
  "pages": {
    "home": {
      "title": {
        "pl": "Ryczywół - wybierz moduł",
        "en": "Ryczywół - choose a module",
        "ua": "Ryczywół - оберіть модуль",
        "ru": "Ryczywół - выберите модуль",
        "az": "Ryczywół - modul seçin",
        "es": "Ryczywół - elige módulo",
        "fil": "Ryczywół - pumili ng module",
        "id": "Ryczywół - pilih modul",
    ...
    "mapa": {
      "title": {
        "pl": "Mapy i dojazd - Ryczywół",
        "en": "Maps and route - Ryczywół",
        "ua": "Карти і дорога - Ryczywół",
        "ru": "Карты и дорога - Ryczywół",
        "az": "Xəritə və yol - Ryczywół",
        "es": "Mapas y ruta - Ryczywół",
        "fil": "Mapa at ruta - Ryczywół",
        "id": "Peta dan rute - Ryczywół",
    ...
    "grupy": {
      ...
      "lead": {
        "pl": "Kafelka na Viber, Telegram i Telegram AZ. Linki zostają wspólne, chyba że podasz inne dla Ryczywołu.",
        "en": "Tile for Viber, Telegram and Telegram AZ. Links stay shared unless you give different ones for Ryczywół.",
        "ua": "Кафель для Viber, Telegram і Telegram AZ. Посилання спільні, якщо не дасте інші для Ryczywołu.",
        "ru": "Плитка для Viber, Telegram и Telegram AZ. Ссылки общие, если не дадите другие для Ryczywołu.",
        "az": "Viber, Telegram və Telegram AZ üçün kafel. Ryczywół üçün başqa link verməsəniz, linklər ümumi qalır.",
  ...
  "maps": [
    ...
    },
    {
      ...
      "note": {
        ...
        "en": "Separate warehouse location. We do not show reader here.",
        "ua": "Окрема локація складу. Тут не показуємо reader.",
        "ru": "Отдельная локация склада. Здесь не показываем reader.",
        "az": "Ayrı anbar yeri. Burada reader göstərmirik.",
        "es": "Ubicación separada de almacén. Aquí no mostramos reader.",
        "fil": "Hiwalay na lokasyon ng bodega. Walang reader dito.",
    ...
    },
    {
      ...
      "note": {
        ...
        "en": "Place for the office if the worker must go there.",
        "ua": "Місце для офісу, якщо працівник має туди прийти.",
        "ru": "Место для офиса, если работник должен туда прийти.",
        "az": "İşçi gəlməlidirsə ofis yeri.",
        "es": "Lugar de oficina si el trabajador debe ir allí.",
        "fil": "Opisina kung kailangan pumunta ang worker.",
  ...
  "groups": [
    {
      ...
      "note": {
        "pl": "Link wspólny. Jeśli dla Ryczywołu będzie inny, podmienimy.",
        "en": "Shared link. If Ryczywół has another one, we will replace it.",
        "ua": "Спільне посилання. Якщо для Ryczywołu буде інше, замінимо.",
        "ru": "Общая ссылка. Если для Ryczywołu будет другая, заменим.",
        "az": "Ümumi link. Ryczywół üçün başqa olsa dəyişəcəyik.",
        "es": "Enlace común. Si Ryczywół tiene otro, lo cambiaremos.",
        "fil": "Shared link. Kung may iba para sa Ryczywół, papalitan.",
        "id": "Link bersama. Jika Ryczywół punya lain, diganti.",
        "ne": "साझा लिंक। Ryczywół को फरक भए बदल्नेछौं।"
      },
