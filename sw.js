...
const CACHE_NAME = CACHE_PREFIX + "20260713-ryczywol-data1";
...
const CORE_ASSETS = [
  ...
  "./assets/css/training.css?v=20260713-ryczywol-data1",
  "./assets/js/training-data.js?v=20260713-ryczywol-lekarz1",
  "./assets/js/location-custom.js?v=20260713-ryczywol-data1",
  "./assets/js/training-app.js?v=20260713-ryczywol-data1",
