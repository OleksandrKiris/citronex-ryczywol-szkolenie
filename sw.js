...
const CACHE_NAME = CACHE_PREFIX + "20260716-voice1-ryczywol";
...
const CORE_ASSETS = [
  ...
  "./assets/css/training.css?v=20260716-voice1-ryczywol",
  "./assets/js/training-data.js?v=20260716-voice1-ryczywol",
  "./assets/js/location-custom.js?v=20260716-voice1-ryczywol",
  "./assets/js/training-app.js?v=20260716-voice1-ryczywol",
