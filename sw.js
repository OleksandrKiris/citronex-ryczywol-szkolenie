...
const CACHE_NAME = CACHE_PREFIX + "20260713-hydra-link1-ryczywol";
...
const CORE_ASSETS = [
  ...
  "./assets/css/training.css?v=20260713-hydra-link1-ryczywol",
  "./assets/js/training-data.js?v=20260713-ryczywol-lekarz1",
  "./assets/js/location-custom.js?v=20260713-contacts1-ryczywol",
  "./assets/js/training-app.js?v=20260713-hydra-link1-ryczywol",
